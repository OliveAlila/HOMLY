...
import com.olive.homly.model.Upload
...
class productviewmodel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName: String, productQuantity: String, productPrice: String) {
        ...
        var productData =
            com.olive.homly.model.Product(productName, productQuantity, productPrice, id)
    ...
    fun viewProducts(
        product: MutableState<com.olive.homly.model.Product>,
        products: SnapshotStateList<com.olive.homly.model.Product>
    ): SnapshotStateList<com.olive.homly.model.Product> {
...
//                    products.add(value)
    ...
    fun updateProduct(name: String, quantity: String, price: String, id: String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = com.olive.homly.model.Product(name, quantity, price, id)
